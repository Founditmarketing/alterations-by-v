      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start space-y-8 md:space-y-0">
          ...
          <div className="flex space-x-8">
            <button onClick={() => onNavigate('services')} className="hover:text-white transition-colors uppercase text-xs tracking-widest">Services</button>
            <button onClick={() => onNavigate('about')} className="hover:text-white transition-colors uppercase text-xs tracking-widest">About</button>
            <button onClick={() => onNavigate('contact')} className="hover:text-white transition-colors uppercase text-xs tracking-widest">Contact</button>
          </div>
