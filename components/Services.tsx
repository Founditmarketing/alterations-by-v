...
const Services: React.FC<ServicesProps> = ({ onConsult }) => {
  return (
    <section id="services" className="py-24 bg-stone-50">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
          ...
          <button
            onClick={onConsult}
            className="hidden md:block text-stone-900 font-bold border-b border-stone-900 pb-1 hover:text-amber-700 hover:border-amber-700 transition-colors mt-6 md:mt-0"
          >
            REQUEST PRICE LIST
          </button>
        </div>
